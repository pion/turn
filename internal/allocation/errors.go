...
var (
	...
	errNilFiveTupleSrcAddr         = errors.New("allocations must not be created with invalid FiveTuple.SrcAddr")
	errNilFiveTupleDstAddr         = errors.New("allocations must not be created with invalid FiveTuple.DstAddr")
